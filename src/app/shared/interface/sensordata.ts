...
export const boatStatusMap: { [fieldName: string]: { icon: string, icon_by_cable: string[], iconfont: string, alarm: string[], datatype: string, unit: string, filter: string, filter_by_cable: string[], name: string, name_by_cable: string[], majorStep: number, show_history: boolean, cable: string[], type: string[], note: string} } = {
    ...
    ExtBatt1Volt: {icon: 'K', icon_by_cable: [], iconfont: 'bo', alarm: ['Ext. Voltage'], datatype: 'float', unit: 'V', filter: '3V', filter_by_cable: [], name: 'Voltage Extern Battery 1', name_by_cable: ['Voltage Extern Battery', 'Voltage Extern Battery 1'], majorStep: 5, show_history: true, cable: ['SINGLE', 'DOUBLE'], type: ['BoatOfficer'], note:''},
    ExtBatt2Volt: {icon: 'K', icon_by_cable: [], iconfont: 'bo', alarm: ['Ext. Voltage'], datatype: 'float', unit: 'V', filter: '', filter_by_cable: [], name: 'Voltage Extern Battery 2', name_by_cable: ['Voltage Extern Battery 2', 'Voltage USB'], majorStep:   0, show_history: true, cable: ['DOUBLE', 'USB'], type: ['BoatOfficer'], note:''},
