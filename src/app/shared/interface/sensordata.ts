...
export const boatStatusMap: { [fieldName: string]: { icon: string, icon_by_cable: string[], iconfont: string, alarm: string[], datatype: string, unit: string, filter: string, filter_by_cable: string[], name: string, name_by_cable: string[], majorStep: number, show_history: boolean, cable: string[], type: string[], note: string} } = {
    time: {icon: 'o', icon_by_cable: [], iconfont: 'bo', alarm: [], datatype: 'bool', unit: '', filter: 'ago', filter_by_cable: [], name: 'Time', name_by_cable: [], majorStep: 0, show_history: false, cable: [], type: [], note:''},
    ExtBatt1Volt: {icon: 'K', icon_by_cable: [], iconfont: 'bo', alarm: ['Ext. Voltage'], datatype: 'float', unit: 'V', filter: '3V', filter_by_cable: [], name: 'Voltage Extern Battery 1', name_by_cable: ['Voltage Extern Battery', 'Voltage Extern Battery 1'], majorStep: 5, show_history: true, cable: ['SINGLE', 'DOUBLE'], type: ['BoatOfficer'], note: localize('sensor_note_ext_batt_volt')},
    ExtBatt2Volt: {icon: 'K', icon_by_cable: [], iconfont: 'bo', alarm: ['Ext. Voltage'], datatype: 'float', unit: 'V', filter: '', filter_by_cable: [], name: 'Voltage Extern Battery 2', name_by_cable: ['Voltage Extern Battery 2', 'Voltage USB'], majorStep:   0, show_history: true, cable: ['DOUBLE', 'USB'], type: ['BoatOfficer'], note: localize('sensor_note_ext_batt_volt')},
    IntTemperature: {icon: 'n', icon_by_cable: [], iconfont: 'bo', alarm: ['Temperature'], datatype: 'float', unit: '°C', filter: '', filter_by_cable: [], name: 'Intern Temperature', name_by_cable: [], majorStep: 5, show_history: true, cable: [], type: ['BoatOfficer', 'to-mslr'], note:''},
    IntBattVolt: {icon: '', icon_by_cable: [], iconfont: 'fas', alarm: ['Internal Battery Voltage'], datatype: 'float', unit: 'V', filter: 'ChargingActive', filter_by_cable: [], name: 'Voltage Intern Battery', name_by_cable: [], majorStep: 1, show_history: true, cable: [], type: ['BoatOfficer', 'to-mslr'], note: localize('sensor_note_int_batt_volt')},
    PressureHektoPascal: {icon: '', icon_by_cable: [], iconfont: 'wi', alarm: ['Pressure'], datatype: 'float', unit: 'hPa', filter: '', filter_by_cable: [], name: 'Pressure in hectopascal', name_by_cable: [], majorStep: 10, show_history: true, cable: [], type: ['to-mslr'], note:''},
    HumidityPercent: {icon: '', icon_by_cable: [], iconfont: 'wi', alarm: ['Humidity'], datatype: 'float', unit: '%', filter: '', filter_by_cable: [], name: 'Humidity', name_by_cable: [], majorStep: 10, show_history: true, cable: [], type: ['to-mslr'], note:''},
    BrightnessPercent: {icon: '', icon_by_cable: [], iconfont: 'fas', alarm: ['Brightness'], datatype: 'float', unit: "%", filter: '', filter_by_cable: [], name: 'Brightness', name_by_cable: [], majorStep: 10, show_history: true, cable: [], type: ['to-mslr'], note:''},
    ReedSensorClosed: {icon: '', icon_by_cable: [], iconfont: 'fas', alarm: [], datatype: 'bool', unit: "", filter: 'closed', filter_by_cable: [], name: 'Reed Sensor Closed', name_by_cable: [], majorStep: 1, show_history: true, cable: [], type: ['to-mslr'], note:''},
    // ChargingActive: {icon: 'U', icon_by_cable: [], iconfont: 'bo', alarm: [], datatype: 'bool', unit: '', filter: 'active', filter_by_cable: [], name: 'Charging active', name_by_cable: [], majorStep: 1, show_history: false, cable: [], note:''},
    // PosMessageSubstitute: {icon: '', icon_by_cable: [], iconfont: 'bo', alarm: [], datatype: 'bool', unit: '', filter: 'hide', filter_by_cable: [], name: 'Position Message Subst.', name_by_cable: [], majorStep: 1, show_history: false, cable: [], note:''},
    // SensorALoopVolt: {icon: 'k', icon_by_cable: [], iconfont: 'bo', alarm: [], datatype: 'float', unit: 'V', filter: '', filter_by_cable: [], name: 'Voltage Loop', name_by_cable: [], majorStep: 1, show_history: true, cable: [], note:''},
    // SensorAMulti1Volt: {icon: 'k', icon_by_cable: [], iconfont: 'bo', alarm: [], datatype: 'float', unit: 'V', filter: '', filter_by_cable: [], name: 'Voltage Multi A 1', name_by_cable: [], majorStep: 1, show_history: true, cable: [], type: ['BoatOfficer'], note:''},
    // SensorAMulti2Volt: {icon: 'k', icon_by_cable: [], iconfont: 'bo', alarm: [], datatype: 'float', unit: 'V', filter: '', filter_by_cable: [], name: 'Voltage Multi A 2', name_by_cable: [], majorStep: 1, show_history: true, cable: [], type: ['BoatOfficer'], note:''},
    StatusLoopA: {icon: '', icon_by_cable: [], iconfont: 'fas', alarm: ['Loop Sensor A Closed', 'Loop Sensor A Opened'], datatype: 'bool', unit: '', filter: 'connected', filter_by_cable: [], name: 'Status Loop A', name_by_cable: ['Multi Sensor', 'Water Sensor'], majorStep: 1, show_history: false, cable: ['MULTI_NONE', 'WATER'], type: ['BoatOfficer'], note:''},
    StatusMultiA1: {icon: '', icon_by_cable: [''], iconfont: 'fas', alarm: ['Multi Sensor A 1 Closed', 'Multi Sensor A 1 Opened'], datatype: 'bool', unit: '', filter: 'closed', filter_by_cable: ['wet'], name: 'Status Multi A1', name_by_cable: ['Water Sensor 1'], majorStep: 1, show_history: false, cable: ['WATER'], type: ['BoatOfficer'], note:''},
    StatusMultiA2: {icon: '', icon_by_cable: [''], iconfont: 'fas', alarm: ['Multi Sensor A 2 Closed', 'Multi Sensor A 2 Opened'], datatype: 'bool', unit: '', filter: 'closed', filter_by_cable: ['wet'], name: 'Status Multi A2', name_by_cable: ['Water Sensor 2'], majorStep: 1, show_history: false, cable: ['WATER'], type: ['BoatOfficer'], note:''},
};
