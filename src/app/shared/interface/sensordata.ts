...
export const boatStatusMap: { [fieldName: string]: { icon: string, icon_by_cable: string[], iconfont: string, alarm: string[], datatype: string, unit: string, filter: string, filter_by_cable: string[], name: string, name_by_cable: string[], majorStep: number, show_history: boolean, cable: string[], type: string[] } } = {
    ...
    StatusLoopA: {icon: '', icon_by_cable: [], iconfont: 'fas', alarm: ['Loop Sensor A Closed', 'Loop Sensor A Opened'], datatype: 'bool', unit: '', filter: 'connected', filter_by_cable: [], name: 'Status Loop A', name_by_cable: ['Multi Sensor', 'Water Sensor'], majorStep: 1, show_history: false, cable: ['NONE', 'WATER'], type: ['BoatOfficer']},
