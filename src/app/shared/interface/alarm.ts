export const alarmSettingsMap: { [fieldName: string]: { key: string, name: string, icon: string, iconfont: string, datatype: string, unit: string, filter?: string } [] } = {
    ...
    Device: [
        {key: 'UserCfg_UpdateRateGeneralEnum', name: 'Update Rate General', icon: '', iconfont: 'bo', datatype: 'float', unit: ' minutes', filter: ''},
        {key: 'UserCfg_UpdateRatePositionEnum', name: 'Update Rate Position', icon: '', iconfont: 'bo', datatype: 'float', unit: ' minutes', filter: ''},
    ]
};
